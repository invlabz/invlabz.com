...
<body>
    ...
    <div class="hero-image"  style="border-top: 3px solid #ff7701;">
    ...
    <footer class="footer-area ">
        ...
        <div class="container ">
                ...
                <div class="col-lg-5 col-md-6 col-sm-6 ">
                    ...
                    <div class="single-footer-widget ">
                        ...
                        <div class="logo ">
                            ...
                            <a href="index.html "><img src="assets/img/logo1.png"></a>
            ...
            <div class="copyright-area ">
                ...
                <p>Copyright @2021 NVLabz. All Rights Reserved || powered by <a href="https://agumentik.com/" rel="noopener" target="_blank">Agumentik Software Private Limited</a></p>
...

{
    ...
    $mail->setFrom('muheebcoder@gmail.com', 'Test Account');
    ...
    $mail->addCC('muheebpasha0@gmail.com');
    ...
    $mail->Body ="Message :".$message." User name : ".$name." and Phone Number: ".$phone;
...
mail ('sanjay46333@gmail.com', 'oneperson want connecte', 'sanjay', $headers);
...
header ("Location: ../reset-password.php?reset=success");
    ...
    //   echo "</pre>";
      ...
      $owneremail = "sanjay46333@gmail.com";
    ...
    $mail->setFrom('sanjay46333@gmail.com', 'Test Account');
