...
<div class="wrapper">
  <div class="cs-wrapper">
    <h1 class="blinking">COMING SOON</h1>
  </div>
</div>
...
<div class="container mt-5">
        ...
        <div class="contact-image">
            ...
            <h2 style="text-transform: uppercase;" class="text-center">Have Any Questions About Us?</h2>

            <br>

            <img src="assets/img/line.PNG" alt="" class="text-center">
        ...
        <div class="column p-3 mb-7">
            ...
            <div class="shadow-lg p-3 mb-5 bg-white rounded" style="border:2px solid #ff7701;">
                ...
                <div class="card border-0">
                    ...
                    <form name="frmContact" id="frmContact" method="post" action="/contact.php" enctype="multipart/form-data" novalidate="">
