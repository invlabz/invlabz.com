...
<!-- Page Content -->
		<div id="content">
			...
			<div class="row no-margin-padding">
				<div class="col-md-3">
					<h4 class="block-title text-white"> team DETAILS </h4>
				</div>
...
?>
										...
										<?php echo "<td><img src='upload/".$row['photo']."'height='100px' width='100px'></td>" ?>
										<?php echo	"<td><a href='edit.php?id=".$row['id']."'>Edit</td>
